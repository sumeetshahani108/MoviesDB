 ...
 */
public class MovieYoutubeVideoAdapter extends RecyclerView.Adapter<MovieYoutubeVideoAdapter.VideoInfoHolder> {
    ...
    public MovieYoutubeVideoAdapter(Context context) {
        this.ctx = context;
    }

    @Override
    public VideoInfoHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.youtube_video_card, parent, false);
